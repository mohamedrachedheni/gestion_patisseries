...
# Envoi d'email — utilisé pour le code de connexion à 6 chiffres (2ᵉ étape de
# /login/, voir core/services.py). Backend "console" par défaut : tant
# qu'aucun SMTP n'est configuré dans .env, les emails s'affichent dans la
# console du serveur de dev au lieu d'échouer silencieusement.
...
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default=EMAIL_HOST_USER or 'no-reply@patisserie-management.local')
